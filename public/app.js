 ...
 const firebaseConfig = {
   apiKey: "AIzaSyAuCS-QL4dgyrK2ErhEteiTVdpcPFVbB6g",
   authDomain: "quiz-app-1a951.firebaseapp.com",
   databaseURL: "https://quiz-app-1a951-default-rtdb.firebaseio.com",
   projectId: "quiz-app-1a951",
   storageBucket: "quiz-app-1a951.appspot.com",
   messagingSenderId: "691958680988",
   appId: "1:691958680988:web:5d39a11d18cd14d1440c59",
   measurementId: "G-NJNX9WY0HP"
 };
...
var questions = [
    ...
    },
    {
      ...
      {
      numb: 6,
      question: "JavaScript is a/an __ Language?",
 ...
 window.skipQuestion = function skipQuestion() {
  ...
  window.checkAns = function (a, b) {
    ...
    if(indexNum + 1 == questions.length) {
      main.innerHTML = `Hi ${name1}, your Marks are: ${marks}/15`
